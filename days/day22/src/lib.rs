...
mod tests {
    ...
    const DATA1: &str = "on x=-20..26,y=-36..17,z=-47..7
...
";
    ...
    const DATA2: &str = "on x=-5..47,y=-31..22,z=-19..33
...
";
    ...
    #[test]
    fn test_part1() {
        let handler = &aoc::InputHandler::new(DATA1);
        assert_eq!(Day22::part1(handler.into()), 590784);
    }

    #[test]
    fn test_part2() {
        let handler = &aoc::InputHandler::new(DATA2);
        assert_eq!(Day22::part2(handler.into()), 2758514936282235);
    }
}
